...
class Home extends Component
{
    render()
    {
        return (
            ...
            <br/>
            <h4 id="mtitle">Test Formatter</h4><br/><br/>
            <h2 id="head1">A PLATFORM</h2>
            <h2 id="head1">FOR ONLINE MOCK TESTS!!!</h2>
            <div className="row">
            ...
            <p style={{marginLeft:"40px"}}>We aid coachings to transform their student’s by developing their skills, to enable them to emerge as “Exam Ready” individuals.</p>
